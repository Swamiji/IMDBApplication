...
public class BackTask1 extends AsyncTask<Void,MovieInformation,String> {
    ...
    String json_string="http://api.themoviedb.org/3/movie/popular?api_key=f47dd4de64c6ef630c2b0d50a087cc33";
    Context context;
    Activity activity;
    ProgressDialog progressdialog;
    public BackTask1(Context context) {
